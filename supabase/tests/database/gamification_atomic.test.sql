...
select extensions.dblink_connect('aa_same_a', 'dbname=postgres user=postgres');
select extensions.dblink_connect('aa_same_b', 'dbname=postgres user=postgres');
...
select extensions.dblink_connect('aa_reset_1', 'dbname=postgres user=postgres');
...
select extensions.dblink_connect('aa_profile_a', 'dbname=postgres user=postgres');
select extensions.dblink_connect('aa_profile_b', 'dbname=postgres user=postgres');
...
select extensions.dblink_connect('aa_reset_2', 'dbname=postgres user=postgres');
...
select extensions.dblink_connect('aa_cleanup', 'dbname=postgres user=postgres');
