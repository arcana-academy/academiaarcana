...
describe("AccessibilityPreferencesProvider", () => {
  ...
  it(
    "compõe a preferência autenticada sobre a preferência local",
    async () => {
  ...
  it(
    "resolve a preferência system conforme o ambiente",
    async () => {
      const dependencies = createDependencies();
  ...
  it(
    "notifica quando a preferência system do ambiente muda",
    async () => {
      const listenerState: {
        current:
          | ((
  ...
  it(
    "altera a preferência de movimento imediatamente",
    async () => {
      const dependencies = createDependencies();
  ...
  it(
    "persiste a preferência autenticada quando existe preferência autenticada",
    async () => {
      const dependencies = createDependencies();
  ...
  it(
    "persiste no repositório autenticado quando existe identidade autenticada mesmo sem preferência anterior",
    async () => {
      const dependencies = createDependencies();
  ...
  it(
    "mantém a preferência atual e sinaliza erro estruturado quando a persistência local falha",
    async () => {
      const dependencies = createDependencies();
  ...
  it(
    "reinicia a observação do sistema ao se inscrever novamente",
    async () => {
  ...
  it(
    "usa o subjectId da identidade autenticada na persistência",
    async () => {
      let loadedSubjectId:
        | string
        | null = null;
