...
export const DOMAIN_POLICIES: Record<CoreDomain, DomainPolicy> = {
  ...
  intelligence: {
    ...
    prohibitedDependencies: ["direct database access", "React", "Next.js UI", "unscoped domain access"],
  ...
  flonts: {
    ...
    allowedDependencies: ["identity", "context", "authorization"],
    prohibitedDependencies: ["direct database access", "React internals in domain contracts", "unscoped domain access"],
  ...
  data: {
    ...
    allowedDependencies: [],
    prohibitedDependencies: ["React", "Next.js UI", "domain business rules", "implicit cross-domain queries"],
