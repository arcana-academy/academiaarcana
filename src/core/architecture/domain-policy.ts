...
export const DOMAIN_POLICIES: Record<CoreDomain, DomainPolicy> = {
  ...
  context: {
    responsibility:
      "Resolve the context in which an action or resource is being used.",
  ...
  authorization: {
    responsibility:
      "Decide whether an actor may perform an action on a resource in a context.",
  ...
  gamification: {
    responsibility:
      "Progress recognition through XP, levels, missions and rewards.",
    owns: [
      "XP",
      "levels",
      "streak",
  ...
  education: {
    ...
    useCases: [
      ...
      "organize educational structure",
    ],
  ...
  adaptive: {
    responsibility:
      "Adapt the learning experience using bounded personalization signals.",
    owns: [
  ...
  intelligence: {
    responsibility:
      "Master Arcane intelligence orchestration through authorized contracts and tools.",
    owns: [
    ...
    excludes: [
      "superuser access",
      "direct universal table access",
      "unbounded domain mutation",
    ],
    entities: ["intelligence request", "tool authorization"],
    useCases: [
      "prepare authorized context",
      "produce suggestion",
  ...
  flonts: {
    responsibility:
      "Flonts product/runtime experience within explicit scope.",
    owns: [
      "Flonts state",
      "expressions",
      "interactions",
      "contextual presentation contract",
    ],
    excludes: [
      "universal data access",
      "authorization bypass",
      "domain ownership outside Flonts",
    ],
    entities: ["Flonts state", "Flonts interaction"],
    useCases: [
      "resolve contextual Flonts state",
      "execute authorized interaction",
    ],
    allowedDependencies: ["identity", "context", "authorization"],
    prohibitedDependencies: [
      "direct database access",
      ...
      "Next.js UI",
      "Supabase client",
      "React internals in domain contracts",
      "unscoped domain access",
    ],
    events: [
      "Flonts state changed",
      "Flonts interaction executed",
    ],
    infrastructure: [
      "runtime adapter",
  ...
  trust: {
    responsibility:
      "Trust, safety and governance mechanisms that are distinct from access decisions.",
    owns: [
      "consent records",
      "trust signals",
      "moderation evidence",
  ...
  data: {
    responsibility:
      "Persistence and data-platform infrastructure without becoming a universal domain owner.",
    owns: [
    ...
    useCases: [
      ...
      "export through domain-owned contracts",
      "delete through domain-owned contracts",
    ],
    allowedDependencies: [],
    prohibitedDependencies: [
      "React",
      ...
      "implicit cross-domain queries",
    ],
    events: [
      "persistence operation completed",
      "portability operation completed",
    ],
    infrastructure: [
      "Supabase adapter",
      "database client",
      "migration adapter",
      "backup/recovery adapter",
    ],
  },
};
