...
const requiredTokenPaths = [
  "surfaces.canvas", "surfaces.panel", "surfaces.elevated", "surfaces.inset",
  "text.primary", "text.secondary", "text.muted", "text.inverse",
  "border.default", "border.strong", "accent.primary", "accent.secondary",
  "status.success", "status.warning", "status.danger", "status.info", "focus.ring",
  "radius.sm", "radius.md", "radius.lg", "spacing.xs", "spacing.sm", "spacing.md", "spacing.lg",
  "typography.body", "typography.heading", "shadows.sm", "shadows.md", "motion.duration", "motion.reduced",
  "density.compact", "density.comfortable", "effects.glow", "effects.texture",
] as const;
...
describe("Academia Arcana theme presets", () => {
  ...
  test("keeps all reference-derived presets independent of vendor naming in token structure", () => {
